...
class UncertainWeighLosses(nn.Module):
    def __init__(self,eps=1e-9):
        ...
        self.alpha_logit = nn.Parameter(torch.tensor(0.0))  # Trainable log variance
        # self.log_sigma2 = nn.Parameter(torch.tensor(0.5))
        self.eps = eps
    ...
    def forward(self, x, y):
        ...
        loss = alpha*loss_all + (1-alpha)*loss_hf
        return loss
...
class VRT(nn.Module):
    ...
    def __init__(self,
        ...
        # self.G_lossfn1 = UncertainWeighLosses(1e-9)
        # conv_first
        if self.pa_frames:
    ...
    # def loss(self, x, y):
    #     return self.G_lossfn1(x, y)
    
    # def loss_sigma(self):
    #     return torch.sigmoid(self.G_lossfn1.alpha_logit), 1-torch.sigmoid(self.G_lossfn1.alpha_logit)